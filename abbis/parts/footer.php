						...
						<div class="form__modal">
							<div class="form__block">
								...
								<div class="form__file formImgFile">
									...
									<div class="formPreview form__file_preview">Файл не выбран</div>
								</div>
							</div>
...
<div class="modal" id="modal__thanks">
	<div class="modal__form">
		...
		<h3>Спасибо, ваш запрос принят!</h3>
		<p>В ближайшее время вы получите ответ на указаный вами адрес електронной почты</p>
	</div>
</div>